						...
						withDockerContainer(args: '--entrypoint=\'\'', image: 'docker/compose:1.23.2', toolName: 'Default') {
							withEnv(["IMAGE_SUFFIX=${imagesuffix}"]) {
								switch(env.BRANCH_NAME) {
								  case "master":
								    sh 'NETWORK_NAME=template_app_nginx_production && chmod 777 ./docker/scripts/configure-network.sh && ./docker/scripts/configure-network.sh'
									...
									break
								  case "staging":
								  	sh 'NETWORK_NAME=template_app_nginx_staging && chmod 777 ./docker/scripts/configure-network.sh && ./docker/scripts/configure-network.sh'
									...
									break
								  case "testing":
								  	sh 'NETWORK_NAME=template_app_nginx_testing && chmod 777 ./docker/scripts/configure-network.sh && ./docker/scripts/configure-network.sh'
									...
									break
								  case "develop":
								  	sh 'NETWORK_NAME=template_app_nginx_development && chmod 777 ./docker/scripts/configure-network.sh && ./docker/scripts/configure-network.sh'
